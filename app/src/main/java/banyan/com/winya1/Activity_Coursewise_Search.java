...
public class Activity_Coursewise_Search extends AppCompatActivity {


    AutoCompleteTextView  auto_course;
    TextView t1;
    Button btn_search;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_coursewise_search);
        ...
        btn_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (str_selected_country_id.isEmpty() && str_selected_course_id.isEmpty()) {
                    ...
                    auto_course.setError("Enter Course");
                    TastyToast.makeText(getApplicationContext(), "Please Enter the COURSE you want to Search for..!", TastyToast.LENGTH_LONG, TastyToast.WARNING);
                } else {
        ...
        try {
            dialog = new SpotsDialog(Activity_Coursewise_Search.this);
            dialog.show();
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        try {
                            adapter_contact1 = new ArrayAdapter<String>(Activity_Coursewise_Search.this,
